...
// optimized for c# 9 by Visual Studio IntelliCode Analyzer
using System;
using System.IO;
using System.Linq;
...
namespace AMWE_Administrator
{
    public class Encryption
    {
        ...
        {
            string code = null;
            Stream stream = Assembly.GetExecutingAssembly().GetManifestResourceStream("AMWE_Administrator.cryptcode.txt");
